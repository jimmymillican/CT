...
namespace ClubMembership.DAL
{
    public class MembershipInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<MembershipContext>
    {
        protected override void Seed(MembershipContext context)
        {
            ...
            {
                new
                Member{FirstName="Vlado",LastName="Kopić",MembershipDate=DateTime.Parse("2013-12-05"),MemberType=MemberType.Peak},
                new
                Member{FirstName="Marin",LastName="Radoš",MembershipDate=DateTime.Parse("2013-02-23"),MemberType=MemberType.OffPeak},
                new
                Member{FirstName="Denis",LastName="Milošević",MembershipDate=DateTime.Parse("2014-04-01"),MemberType=MemberType.Peak},
                new
                Member{FirstName="Michael",LastName="Tilhof",MembershipDate=DateTime.Parse("2014-08-11"),MemberType=MemberType.OffPeak},
                new
                Member{FirstName="Bruno",LastName="Brekalo",MembershipDate=DateTime.Parse("2015-11-12"),MemberType=MemberType.Peak},
                new
                Member{FirstName="Dinko",LastName="Tarakčija",MembershipDate=DateTime.Parse("2015-12-12"),MemberType=MemberType.OffPeak}
                };
            ...
            var Campaigns = new List<Campaign>
                ...
                AddOrUpdateMember(context, "Out of the Abyss", "Tilhof");
                AddOrUpdateMember(context, "Lost Mine of Phandelver", "Radoš");
                AddOrUpdateMember(context, "Lost Mine of Phandelver", "Brekalo");
                AddOrUpdateMember(context, "Lost Mine of Phandelver", "Tarakčija");
                AddOrUpdateMember(context, "Lord of the Iron Fortress", "Tarakčija");
                AddOrUpdateMember(context, "Lord of the Iron Fortress", "Kopić");
                AddOrUpdateMember(context, "Lord of the Iron Fortress", "Milošević");
        }
