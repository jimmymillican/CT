...
namespace ClubMembership.Controllers
{
    public class AvatarController : Controller
    {
        ...
        {
            ViewBag.id = id;
            Member member = db.Members.Single(i => i.Id == id);
            return View(member);
        }

        [HttpGet]
        public ActionResult _Upload(int id)
        {
            ViewBag.id = id;
            Member member = db.Members.Single(i => i.Id == id);
        ...
        public ActionResult _Upload(IEnumerable<HttpPostedFileBase> files, int? id)
        {
        ...
        public ActionResult Save(string t, string l, string h, string w, string fileName,int? id)
        {
            try
            {
                ...
                string newFileNameStart = id.ToString();
                var newFileName = Path.Combine(AvatarPath, (newFileNameStart + extension));
                ...
                //return RedirectToAction("Edit", "Member", new { id = newFileNameStart });
